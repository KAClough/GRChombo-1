...
timedata = data1[:,0]
M0 = symmetry*data1[N,1]
dM = symmetry*data1[:,1] - M0
#print(dM)
...
plt.semilogy(timedata, Fdt, '-', lw = 1.0, label="net flux")
plt.semilogy(timedata, FIdt, '-', lw = 1.0, label="inner flux")
plt.semilogy(timedata, FOdt, '-', lw = 1.0, label="outer flux")
plt.semilogy(timedata, dM, '-', lw = 1.0, label="M-M0")
