...
#ifndef COMPLEXPROCAFIELDCONSTRAINTS_HPP_
#define COMPLEXPROCAFIELDCONSTRAINTS_HPP_
...
template <class matter_t, class potential_t> class ComplexProcaFieldConstraints
{
  public:
    ...
    template <class data_t>
    struct BSSNMatterVars : public CCZ4::Vars<data_t>,
    ...
    //!  Constructor of class ComplexProcaFieldConstraints
    /*!
...
#endif /* COMPLEXPROCAFIELDCONSTRAINTS_HPP_ */
